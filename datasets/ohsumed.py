...
def char_quantize_ohsumed():
    return char_quantize_class(OHSUMEDCharQuantized)


class OHSUMEDCharQuantized(OHSUMED):
    ALPHABET = ALPHABET_DICT
    TEXT_FIELD = Field(sequential=False, use_vocab=False, batch_first=True, preprocessing=char_quantize_ohsumed())
