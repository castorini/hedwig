...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='Reuters', choices=['Reuters', 'AAPD', 'IMDB', 'Yelp2014', 'AG_NEWS', 'DBpedia', 'IMDB_torchtext', 'SogouNews', 'YahooAnswers', 'YelpReviewPolarity', 'TwentyNews'])
